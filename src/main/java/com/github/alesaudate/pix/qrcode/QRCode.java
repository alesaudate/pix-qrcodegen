...
public abstract class QRCode {
    ...
    protected void addBlockWithinMerchantAccountInformation(SimpleBlock simpleBlock) {
        addBlock(new CompositeBlock(MERCHANT_ACCOUNT_INFORMATION_BLOCK_CODE, asList(MERCHANT_ACCOUNT_INFORMATION_GUI_BLOCK, simpleBlock)));
    }
    ...
    protected void validate() {
        ...
        this.blocks.stream().map(Block::getBlockCodesForValidation).flatMap(Collection::stream).forEach(mandatoryBlockCodes::remove);
